...
const WORLD_BOSSES = {
  thornback_ancient: {
    ...
    loot: [
      { itemId: 'moss_shell', qty: [3, 5], chance: 1.0 },
      { itemId: 'thorn', qty: [2, 4], chance: 0.9 },
      { itemId: 'ancient_heart', qty: [1, 1], chance: 0.15 },
      { itemId: 'inferno_blade', qty: [1, 1], chance: 0.05 },
    ],
    xpReward: 500,
  ...
  forest_guardian: {
    ...
    loot: [
      { itemId: 'thorn', qty: [3, 5], chance: 1.0 },
      { itemId: 'wind_essence', qty: [2, 4], chance: 0.8 },
      { itemId: 'ancient_heart', qty: [1, 1], chance: 0.10 },
      { itemId: 'volcanic_fang', qty: [1, 1], chance: 0.08 },
    ],
    xpReward: 300,
  ...
  storm_titan: {
    ...
    loot: [
      { itemId: 'stone_fragment', qty: [3, 5], chance: 1.0 },
      { itemId: 'hawk_feather', qty: [2, 4], chance: 0.8 },
      { itemId: 'ancient_heart', qty: [1, 1], chance: 0.12 },
      { itemId: 'crystal_edge', qty: [1, 1], chance: 0.07 },
    ],
    xpReward: 400,
    announceLeadTime: 60000,
  },
  ...
  abyssal_hydra: {
    ...
    loot: [
      ...
      { itemId: 'lurker_fang', qty: [2, 4], chance: 0.8 },
      { itemId: 'ancient_heart', qty: [1, 1], chance: 0.15 },
      { itemId: 'sky_talon', qty: [1, 1], chance: 0.06 },
    ],
    xpReward: 600,
    announceLeadTime: 60000,
  },
  ...
  inferno_titan: {
    ...
    loot: [
      { itemId: 'lava_essence', qty: [3, 5], chance: 1.0 },
      { itemId: 'magma_core', qty: [2, 4], chance: 0.85 },
      { itemId: 'lava_heart', qty: [1, 1], chance: 0.12 },
  ...
  crystal_queen: {
    ...
    loot: [
      { itemId: 'crystal_shard', qty: [3, 5], chance: 1.0 },
      { itemId: 'prism_core', qty: [2, 4], chance: 0.85 },
  ...
  sky_dragon: {
    ...
    loot: [
      { itemId: 'storm_essence', qty: [3, 5], chance: 1.0 },
      { itemId: 'sky_feather', qty: [2, 4], chance: 0.85 },
  ...
  chaos_emperor: {
    ...
    loot: [
      { itemId: 'void_essence', qty: [3, 5], chance: 1.0 },
      { itemId: 'chaos_core', qty: [2, 4], chance: 0.85 },
      { itemId: 'void_shard', qty: [1, 1], chance: 0.04 },
      { itemId: 'chaos_heart', qty: [1, 1], chance: 0.03 },
    ],
    xpReward: 5000,
    announceLeadTime: 60000,
  },
