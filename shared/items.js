...
const ITEMS = {
  ...
  tempest_dual:     { name: 'Twin Fangs of the Fracture',     type: 'equipment', slot: 'weapon', classReq: ['blade_dancer'], tier: 3, stats: { atk: 11, spd: 5, crit: 0.08, def: 1 }, price: 750, icon: { bg: 0x006064, fg: 0x84FFFF, symbol: '//' } },

  willow_staff:     { name: 'Staff of Whispered Roots',     type: 'equipment', slot: 'weapon', classReq: ['sage'],         tier: 1, stats: { atk: 2, mp: 15 },          price: 90,  icon: { bg: 0x795548, fg: 0xD7CCC8, symbol: '|' } },
  deepwood_rod:     { name: 'Rod of the Forgotten Shrine',     type: 'equipment', slot: 'weapon', classReq: ['sage'],         tier: 2, stats: { atk: 5, mp: 30, spd: 2 },  price: 300, icon: { bg: 0x2E7D32, fg: 0xA5D6A7, symbol: '|' } },
  arcane_focus:     { name: 'The Conduit Focus',     type: 'equipment', slot: 'weapon', classReq: ['sage'],         tier: 3, stats: { atk: 9, mp: 50, spd: 3, crit: 0.05 }, price: 700, icon: { bg: 0x4A148C, fg: 0xCE93D8, symbol: '|' } },

  pilgrim_staff:    { name: 'Staff of the Wandering Light',    type: 'equipment', slot: 'weapon', classReq: ['cleric'],       tier: 1, stats: { atk: 2, mp: 10, hp: 10 },  price: 100, icon: { bg: 0xA1887F, fg: 0xEFEBE9, symbol: '|' } },
  shrine_scepter:   { name: 'Blessing of the First Shrine',   type: 'equipment', slot: 'weapon', classReq: ['cleric'],       tier: 2, stats: { atk: 4, mp: 25, hp: 20 },  price: 320, icon: { bg: 0xF5F5F5, fg: 0xFFD600, symbol: '|' } },
