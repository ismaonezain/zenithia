...
function initNPCs() {
  ...
  // rot = rotation in radians (facing direction toward nearest path)
  return {
    elder_maren:     { id: 'elder_maren', name: 'Elder Maren', title: 'Village Elder', x: 0, z: -11, rot: 0 },
    ...
    kris:            { id: 'kris', name: 'Kris', title: 'Troublemaker', x: -2, z: -7, rot: 0 },
